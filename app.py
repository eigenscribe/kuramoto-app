...
<style>
    ...
    /* Apply green gradient to sidebar labels */
    .sidebar .sidebar-content label {{
        background: -webkit-linear-gradient(#66ffaa, #33cc77, #22aa55);
...
st.sidebar.markdown("<h2 style='background: linear-gradient(to right, #33ccff, #0088ee, #0066dd); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-weight: bold;'>Simulation Parameters</h2>", unsafe_allow_html=True)
...
with tab3:
    ...
    # Create a more space-efficient layout with reorganized plots
    ...
    with col2:
        # Blank space for a new plot to be defined later
        st.markdown("""
        <div style="background-color:rgba(20,20,40,0.3); border-radius:15px; height:340px; display:flex; 
                   justify-content:center; align-items:center; border:1px dashed #5555aa;">
            <p style="color:#8888cc; font-style:italic; text-align:center;">
                Space reserved for<br>additional visualization
            </p>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class='section'>
        ...
        <p>The <b>middle plot</b> shows the order parameter over time, with color-coded dots showing the synchronization level from 0 (no synchronization) to 1 (complete synchronization).</p>
        ...
        <p>The <b>bottom right space</b> is reserved for additional visualization to be added later.</p>
        <p>Click "Play Animation" to watch all visualizations animate together to see the synchronization process in real-time.</p>
    </div>
    """, unsafe_allow_html=True)
